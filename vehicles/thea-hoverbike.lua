...
function init()
  ...
  animator.setGlobalTag("smallThrusterFrame", 1)
...
function updateDriveEffects(healthFactor, driverThisFrame)
  ...
  if (self.loopPlaying~=nil) then
    ...
    if (self.engineVolume == self.engineIdleVolume) then
	  ...
	  animator.setParticleEmitterActive("smallThrusterIdle", true)
      animator.setParticleEmitterActive("smallThrusterDrive", false)
    else
      animator.setParticleEmitterActive("rearThrusterIdle", false)
      animator.setParticleEmitterActive("rearThrusterDrive", true)
	  animator.setParticleEmitterActive("smallThrusterIdle", false)
      animator.setParticleEmitterActive("smallThrusterDrive", true)
      rearThrusterFrame = 3
	  smallThrusterFrame = 3
    end
	...
	animator.setAnimationState("smallThruster", "on")
    ...
    animator.setAnimationState("rearThruster", "off")
    animator.setAnimationState("bottomThruster", "off")
	animator.setAnimationState("smallThruster", "off")
  end
  ...
  smallThrusterFrame = smallThrusterFrame+math.random(3)
  animator.setGlobalTag("smallThrusterFrame", smallThrusterFrame)
