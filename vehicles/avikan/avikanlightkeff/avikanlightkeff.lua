...
function init()
  ...
  self.liquidCheckPosition = config.getParameter("liquidCheckPosition")
  self.liquidCheckPositionForRotation = config.getParameter("liquidCheckPositionForRotation")
  self.hoverOverLiquidDistance = config.getParameter("hoverOverLiquidDistance")
