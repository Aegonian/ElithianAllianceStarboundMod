...
function TheaChainSaw:damageTiles()
  ...
  local tileDamage = root.evalFunction("thea-chainsawMiningStrengthTimeMultiplier", config.getParameter("level", 1)) * self.tileDamage
  ...
  world.debugText(tileDamage, mcontroller.position(), "red")
end
