...
TheaExplosiveHammerSmash = MeleeSlash:new()
function TheaExplosiveHammerSmash:init()
...
function TheaExplosiveHammerSmash:windup(windupProgress)
...
function TheaExplosiveHammerSmash:winddown(windupProgress)
  self.weapon:setStance(self.stances.windup)
...
function TheaExplosiveHammerSmash:fire()
...
function TheaExplosiveHammerSmash:spin()
  self.weapon:setStance(self.stances.fire)
  self.weapon:updateAim()
...
function TheaExplosiveHammerSmash:uninit()
...
function TheaExplosiveHammerSmash:setupInterpolation()
...
function TheaExplosiveHammerSmash:bounceWeaponAngle(ratio)
...
function TheaExplosiveHammerSmash:windupAngle(ratio)
