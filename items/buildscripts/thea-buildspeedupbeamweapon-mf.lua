...
function build(directory, config, parameters, level, seed)
  ...
  if config.tooltipKind ~= "base" then
    ...
    config.tooltipFields.dpsLabel = "" .. util.round((config.primaryAbility.baseDps or 0) * config.damageLevelMultiplier, 1) .. ">" .. util.round((config.primaryAbility.baseDps or 0) * config.damageLevelMultiplier * (config.primaryAbility.minFiringSpeed / config.primaryAbility.maxFiringSpeed), 1) .. ""
