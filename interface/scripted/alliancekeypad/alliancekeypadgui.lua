...
function updateSlots()
  ...
  if self.slotOne == nil then
	widget.setImage("scrnSlot1", "/interface/scripted/alliancekeypad/screen_empty.png")
  else
	widget.setImage("scrnSlot1", "/interface/scripted/alliancekeypad/screen_"..self.slotOne..".png")
  end
  --Slot Two
  if self.slotTwo == nil then
	widget.setImage("scrnSlot2", "/interface/scripted/alliancekeypad/screen_empty.png")
  else
	widget.setImage("scrnSlot2", "/interface/scripted/alliancekeypad/screen_"..self.slotTwo..".png")
  end
  --Slot Three
  if self.slotThree == nil then
	widget.setImage("scrnSlot3", "/interface/scripted/alliancekeypad/screen_empty.png")
  else
	widget.setImage("scrnSlot3", "/interface/scripted/alliancekeypad/screen_"..self.slotThree..".png")
  end
  --Slot Four
  if self.slotFour == nil then
	widget.setImage("scrnSlot4", "/interface/scripted/alliancekeypad/screen_empty.png")
  else
	widget.setImage("scrnSlot4", "/interface/scripted/alliancekeypad/screen_"..self.slotFour..".png")
  end
  --Slot Five
  if self.slotFive == nil then
	widget.setImage("scrnSlot5", "/interface/scripted/alliancekeypad/screen_empty.png")
  else
	widget.setImage("scrnSlot5", "/interface/scripted/alliancekeypad/screen_"..self.slotFive..".png")
  end
